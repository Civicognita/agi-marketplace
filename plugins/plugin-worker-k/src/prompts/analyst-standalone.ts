...
export const analystStandalone: WorkerDefinition = {
  id: "analyst",
  name: "Analyst",
  domain: "k",
  role: "analyst",
  description: "Non-interactive analysis worker for pattern recognition, data review, and codebase exploration tasks. Spawned by terminal agents for parallel processing.",
  modelTier: "fast",
  allowedTools: ["Read", "Glob", "Grep"],
  keywords: ["analyze", "pattern", "explore", "summarize", "review", "statistics"],
  prompt: `---
name: worker-analyst
